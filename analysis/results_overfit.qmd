...
if (redownload) {
  ...
  data.exp <- rbind(read.csv(paste(src_folder, 'pm_exp_whas/results_overfit.csv', sep = '/')),
                    read.csv(paste(src_folder, 'pm_exp_gbcs/results_overfit.csv', sep = '/')),
                    read.csv(paste(src_folder, 'pm_exp_aids/results_overfit.csv', sep = '/')),
                    read.csv(paste(src_folder, 'pm_exp_veteran/results_overfit.csv', sep = '/')),
                    read.csv(paste(src_folder, 'pm_exp_pbc/results_overfit.csv', sep = '/')))
  ...
  data <- rbind(data.rsf, data.cox, data.exp, data.wb, data.nnwb, data.dps)
...
data <- data.raw %>%
  mutate(experiment_name = experiment,
         ...
         model_lbl = factor(model, labels = c("CoxPH", "DeepSurv", "PM Exp", "PM NN", "PM Wb", "RSF")), # 
